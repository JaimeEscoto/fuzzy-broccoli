   ...
   <body>
      <div class="page-wrap">
         ...
         <section id="main">
            <!-- Header -->
            <header id="header">
               <div>Follow us in Istagram with our official hashtag <span>#BestShotPost</span></div>
            </header>
            <!-- Gallery -->
                        ...
                        <div class="social column">
                           <table>
                              <tr>
                                 ...
                                 <td>
                                    <h5><img src="images/love.png" height="16" width="16"><?php echo ": ".$post->likes->count; ?></h5>
                                 </td>
                                 <td>
